...
BALANCER_VAULT_V3_ABI = [ { 'inputs': [ { 'internalType': 'contract IVault',
                  'name': 'mainVault',
                  'type': 'address'},
  ...
  { 'inputs': [ { 'internalType': 'uint256',
    ...
    'type': 'error'},
  { 'inputs': [ { 'internalType': 'contract IERC4626',
                  'name': 'wrappedToken',
                  'type': 'address'}],
  ...
  { 'anonymous': False,
    'inputs': [ { 'indexed': True,
                ...
                { 'indexed': True,
                  ...
                  'name': 'factory',
                  'type': 'address'},
                { 'components': [ { 'internalType': 'contract IERC20',
                                    'name': 'token',
                                    'type': 'address'},
  ...
  { 'inputs': [ {'internalType': 'address', 'name': 'token', 'type': 'address'},
    ...
    'type': 'function'},
  { 'inputs': [ {'internalType': 'address', 'name': 'pool', 'type': 'address'},
                { 'components': [ { 'internalType': 'enum SwapKind',
                                    'name': 'kind',
                                    'type': 'uint8'},
                                  { 'internalType': 'uint256',
  ...
  { 'inputs': [],
    'name': 'getAuthorizer',
    'outputs': [ { 'internalType': 'contract IAuthorizer',
                   'name': '',
                   'type': 'address'}],
    'stateMutability': 'view',
    'type': 'function'},
  ...
  { 'inputs': [{'internalType': 'address', 'name': 'pool', 'type': 'address'}],
    'name': 'getPoolConfig',
    'outputs': [ { 'components': [ { 'components': [ { 'internalType': 'bool',
                                                       'name': 'disableUnbalancedLiquidity',
                                                       'type': 'bool'},
                                                     { 'internalType': 'bool',
                                                       'name': 'enableAddLiquidityCustom',
  ...
  { 'inputs': [{'internalType': 'address', 'name': 'pool', 'type': 'address'}],
    'name': 'getPoolData',
    'outputs': [ { 'components': [ { 'internalType': 'PoolConfigBits',
                                     'name': 'poolConfigBits',
                                     'type': 'bytes32'},
                                   { 'internalType': 'contract IERC20[]',
                                     'name': 'tokens',
                                     'type': 'address[]'},
                                   { 'components': [ { 'internalType': 'enum '
                                                                       'TokenType',
                                                       'name': 'tokenType',
                                                       'type': 'uint8'},
  ...
  { 'inputs': [],
    ...
    'outputs': [ { 'internalType': 'contract IProtocolFeeController',
                   'name': '',
                   'type': 'address'}],
    'stateMutability': 'view',
    'type': 'function'},
  ...
  { 'inputs': [],
    'name': 'vault',
    'outputs': [ { 'internalType': 'contract IVault',
                   'name': '',
                   'type': 'address'}],
    'stateMutability': 'view',
    'type': 'function'},
